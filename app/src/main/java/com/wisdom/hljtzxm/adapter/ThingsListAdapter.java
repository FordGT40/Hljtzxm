...
public class ThingsListAdapter extends BaseAdapter {
    ...
    private List<ThingsModel> listData;

    public ThingsListAdapter(Context context, List<ThingsModel> listData) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.textView.setText(listData.get(position).getITEM_NAME());
